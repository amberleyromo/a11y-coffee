...
Happy (hopefully chill) Friday! End of the week and you don't want to dig into a new big ticket, but want to make an impact? DO deploy, and make it an a11y fix.
