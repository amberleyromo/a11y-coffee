...
> Note: Automated testing can only detect around 25% of possible WCAG conformance failures.[^webaim-million] The absence of detectable errors does not necessarily mean that a site is accessible or compliant.
...
> Note: The second example shown is deliberately illegible. It shows white text on a white background, illustrating a contrast ratio of 1:1.
