...
- [Most common web accessibility errors](/quick-wins/#most-common-web-accessibility-errors)
  ...
  5. [Missing document language](/quick-wins/#5-missing-document-language)
  6. [Empty Buttons](/quick-wins/#6-empty-buttons)
...
> _The first example shows black text on a white background. The second example shows white text on a white background, illustrating a contrast ratio of 1:1, which is completely imperceptible to anyone._
